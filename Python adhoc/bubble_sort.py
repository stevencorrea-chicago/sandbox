...
for num in range(len(random_numbers)):
    for num2 in range(0, len(random_numbers)-num-1):
        if random_numbers[num2] > random_numbers[num2+1]:
            random_numbers[num2], random_numbers[num2+1] = random_numbers[num2+1], random_numbers[num2]
end_time = time.time()
